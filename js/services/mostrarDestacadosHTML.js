...
function obtenerJuegoPorId(id, juego) {
  ...
  CardPrincipal.innerHTML = `
              <img src="${image2}" class="card-img rounded-5 aparecer-poco-a-poco sombra-difuminada animacion-principal " alt="imagen-portada"/>
              <div class="card-img-overlay p-2 d-flex flex-column justify-content-between justify-content-md-around">
                ...
                <div class="row mb-md-3 ps-md-3">
                  <div>
                    <p class=" card-text fw-bold text-light mt-5 text-center text-md-start mb-md-0 ps-md-4 mb-md-1 animacion-principal ">${category}</p>
                  ...
                  <div class=" text-center text-md-start mb-5  ps-md-4">
                    <a href="${id}" class="btn btn-light fw-bold fs-6 pb-1">
